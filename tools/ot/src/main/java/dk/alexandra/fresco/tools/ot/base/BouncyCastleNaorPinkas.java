...
public class BouncyCastleNaorPinkas extends AbstractNaorPinkasOT{
    ...
    public BouncyCastleNaorPinkas(int otherId, Drbg randBit, Network network, DHParameterSpec params) {
    ...
    AbstractNaorPinkasElement generateRandomNaorPinkasElement() {
        return new BouncyCastleECCElement(this.dhGenerator.multiply(this.randNum.nextBigInteger(this.dhModulus)));
    }
